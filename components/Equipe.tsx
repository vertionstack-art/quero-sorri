...
export function Equipe() {
  ...
  return (
    <section id="equipe" className="scroll-mt-20 bg-pine text-paper">
      <div className="mx-auto grid max-w-6xl items-center gap-0 lg:grid-cols-[0.92fr_1.08fr]">
        ...
        <div className="order-1 px-5 py-16 sm:py-20 lg:order-2 lg:py-24 lg:pr-8 lg:pl-14">
          ...
          <p className="medida mt-5 text-sage">{equipe.texto}</p>

          <div className="mt-9 border-t border-line-dark pt-6">
            <p className="text-[0.8125rem] font-medium tracking-[0.05em] text-sage/70">
              {responsavel.rotulo}
            </p>
            <p className="display mt-2 text-[1.375rem] leading-snug">
              <Pendente escuro>{responsavel.nome.valor}</Pendente>
            </p>
            <p className="mt-3 text-[1rem] text-sage">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-3 border-t border-line-dark pt-6">
            <p className="flex items-baseline gap-2">
              <span className="display text-[2.25rem] leading-none">
                {google.nota.toLocaleString("pt-BR")}
              </span>
              <span className="flex gap-0.5 self-center text-gold" aria-hidden="true">
                {[0, 1, 2, 3, 4].map((i) => (
            ...
            <p className="text-[0.9375rem] text-sage">
              ...
              <a
                ...
                className="underline decoration-sage/40 underline-offset-4 hover:decoration-sage"
              >
                Ler as avaliações
              </a>
            </p>
